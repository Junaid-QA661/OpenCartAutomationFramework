...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		String os = testContext.getCurrentXmlTest().getParameter("os"); //Getting OS name from XML file
		extent.setSystemInfo("Operating System", os);

		String browser = testContext.getCurrentXmlTest().getParameter("browser"); ////Getting browser name from XML file
